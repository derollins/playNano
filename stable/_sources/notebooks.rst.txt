...
and install the optional notebook dependencies using ``pip install .[notebooks]``.
...
Run each cell in the notebooks sequentially to see the workflow in action. Initially example data from
